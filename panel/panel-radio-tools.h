...
static void radio_tools_sections(cJSON *root){
 ...
 i=radio_button(s,"sms.delete","删除指定短信","form","需要确认；不可恢复",RADIO_CAP("sms-delete"),"本固件删除需先实机验收，默认禁用",1);field(i,"id","要删除的短信 ID","","number",1);
