...
static int web_action_allowed(const char *s) {
 ...
 "web.clash.state","web.clash.subscription_save","web.clash.subscription_delete","web.clash.connection_close","web.tailscale.state","web.tailscale.hostname","web.tailscale.routes","web.tailscale.netcheck",
 ...
 "usb.power_role","usb.role","clash.close_connections","clash.delay","clash.flush_dns","clash.mode","clash.provider","clash.rule_add","clash.rule_edit","clash.rule_provider","clash.select","clash.service",
