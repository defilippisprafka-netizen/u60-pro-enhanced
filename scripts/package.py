...
VERSION='v0.1.2-experimental';out=R/'dist'/('u60-pro-enhanced-'+VERSION)
...
shutil.copyfile(R/'packaging/FACTORY-SHA256SUMS',i/'FACTORY-SHA256SUMS');(i/'RELEASE-ID').write_text('u60-pro-B28-20260922-200000\n')
