...
cd "$(dirname "$0")/.."
mkdir -p build/tests
for source in tests/test-menu-layout.c tests/test-advanced-control.c tests/test-radio-tools.c tests/test-charge.c tests/test-power-role.c tests/test-web-policy.c tests/test-standby-policy.c tests/test-relay.c;do
